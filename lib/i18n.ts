...
const messages: Record<Language, Messages> = {
  ko: {
    ...
    stage1SummaryTag: 'Stage 1 요약',
    stage1SummaryHeading: '마음에 든 역할',
    stage1SummarySubheading: '좋아요로 스와이프한 역할을 모았어요.',
    stage1SummaryEmpty: '좋아요한 역할이 없어요. 다시 스와이프해 보세요.',
    stage1SummaryHint: '가로로 스와이프하거나 스크롤해 살펴보세요.',
    stage1SummaryPrev: '이전',
    stage1SummaryNext: '다음',
    stage1SummaryRoleModels: '롤모델',
    stage1SummaryWhereWork: '함께할 수 있는 곳',
    stage1SummaryBackDashboard: '대시보드로',
    stage1SummaryNextStage: 'Stage 2로 이동',
    stage1SummaryRedo: '초기화하고 Stage 1 다시',
    stage1SummaryConfirmTitle: '좋아요를 지울까요?',
    stage1SummaryConfirmBody: '스와이프 기록이 삭제되고 Stage 1을 다시 시작합니다.',
    stage1SummaryConfirmCancel: '취소',
    stage1SummaryConfirmConfirm: '네, 지우기',
    stage1SummaryRolesLikedTitle: '좋아요한 역할',
    stage1SummaryViewAll: '전체 보기',
    // Stage 2
  ...
  en: {
    ...
    stage1SummaryTag: 'Stage 1 summary',
    stage1SummaryHeading: 'Roles that caught your eye',
    stage1SummarySubheading: 'Here are the roles you swiped like. Save them for what comes next.',
    stage1SummaryEmpty: 'No liked roles yet. Try swiping right on a few roles first.',
    stage1SummaryHint: 'Swipe or scroll to browse your liked roles.',
    ...
    stage1SummaryNextStage: 'Continue to Stage 2',
    stage1SummaryRedo: 'Clear & redo Stage 1',
    stage1SummaryConfirmTitle: 'Clear liked roles?',
    stage1SummaryConfirmBody:
    ...
    stage1SummaryConfirmConfirm: 'Yes, clear',
    stage1SummaryRolesLikedTitle: 'Roles you liked',
    stage1SummaryViewAll: 'View all',
    // Stage 2
